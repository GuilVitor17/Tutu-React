        ...
        const handlepagamento = async () => {
            ...
            try {
               ...
               await Swal.fire({
                ...
                localStorage.setItem('curso', 'aprovado')

                navigate(`/perfil/aulaspagas/preparativo`)
...
export default ConfirmSonhoSuccess;
