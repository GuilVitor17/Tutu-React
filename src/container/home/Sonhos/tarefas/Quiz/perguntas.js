        ...
        <div className="quiz">
            ...
            <div className='barra-fixed'>
                ...
                <div className='barra-alta-home'>
                    ...
                    <Link to='/perfil/quiz'> <div className='Logo-volta'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-left" viewBox="0 0 16 16">
