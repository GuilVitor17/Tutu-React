...
function CreateFormSonhos() {
    ...
    const handleNewSonho = async (e) => {
        ...
        try {
            ...
            await axios.post(`${process.env.REACT_APP_API_URL}/sonho`, {
                nameSonho: nameSonho,
        ...
        <div className="create-sonhos-create">
            <div className='barra-fixed'>
                ...
                <div className='barra-alta-home'>
                    ...
                    <Link to='/perfil/createsonhospost'> <div className='Logo-volta'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-left" viewBox="0 0 16 16">
            ...
            <Form onSubmit={handleNewSonho}>
                ...
                <div className='form-create-sonho'>
                    ...
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        ...
                        <Form.Control maxLength={20} type="text" value={nameSonho} onChange={handleNameSonho} required />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                        <Form.Label> <h5>O que vai fazer quando conquistar?</h5></Form.Label>
                        <Form.Control maxLength={80} type='text' value={descricaoSonho} onChange={handleDescricaosonho} required />
                    </Form.Group>
                ...
                <div className='div-sonhos-categoria-craete'>
                    ...
                    <div className='tempo-sonho'>
                        ...
                        <div>
                            ...
                            <Button variant="outline-warning" value={48} onClick={handleChange2}>4 - ANO</Button>
                    ...
                    <div className='valorCalculado'>
                        ...
                        <Form.Group id='input-commit' className="mb-3" controlId="exampleForm.ControlTextarea1">
                            <Form.Control maxLength={130} type='text' placeholder='Escreva um comentario!' value={comentario} onChange={handleSonhoComenatrio} required />
                        </Form.Group>
