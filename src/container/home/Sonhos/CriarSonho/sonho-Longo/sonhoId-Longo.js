...
function SonhosId() {
    ...
    const Id = localStorage.getItem('IdSonhoLongo')
    ...
    useEffect(() =>{
        ...
        try {
           ...
           await axios.get(`${process.env.REACT_APP_API_URL}/sonhoLongo/${Id}`,{
    ...
    const deleteTarefas = async () => {
        ...
        try {
            ...
            await axios.delete(`${process.env.REACT_APP_API_URL}/sonhoLongo/${Id}`, {
